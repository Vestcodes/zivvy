...
export const MODULE_NAVS: Record<string, ModuleNav> = {
  ...
  finance: {
    ...
    items: [
      { label: "Banking", href: "/finance/banking", icon: Landmark, module: "Accounts" },
      { label: "Reconciliation", href: "/finance/banking/reconciliation", icon: ClipboardCheck, module: "Accounts" },
      { label: "Bank accounts", href: "/finance/banking/accounts", icon: Building2, module: "Accounts" },
      { label: "Transactions", href: "/finance/banking/transactions", icon: ArrowLeftRight, module: "Accounts" },
      { label: "Statement imports", href: "/finance/banking/statements/import", icon: Upload, module: "Accounts" },
      { label: "Payment requests", href: "/finance/payment-requests", icon: SendHorizontal, module: "Accounts" },
      { label: "Payment reconciliation", href: "/finance/payment-reconciliation", icon: Scale, module: "Accounts" },
