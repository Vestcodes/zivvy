  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-6 pt-24 pb-16 text-center sm:pt-32">
        ...
        <Reveal delay={80} as="h1" className="font-display text-5xl leading-[1.02] tracking-tight text-foreground sm:text-7xl">
          The clean way to run your <em className="italic text-foreground/85">whole business</em>.
        </Reveal>
        <Reveal delay={160} as="p" className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
        ...
        <Reveal delay={320} as="p" className="mt-6 text-xs text-muted-foreground">
