# Zivvy Manufacturing — Work Order / BOM
...
6. **Optional enrich:** Webhooks by Zapier GET `https://api.zivvy.xyz/v1/work-orders/{{name}}` with Bearer `zk_live_`
...
Import/push `zapier-templates/integration` (Platform CLI) for a first-class **Work Order / BOM / Job Card Event** trigger — see root README.
