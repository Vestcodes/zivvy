...
6. **Optional enrich:** Webhooks by Zapier GET `https://api.zivvy.xyz/v1/leads/{{name}}` with Bearer `zk_live_`
...
Import/push `zapier-templates/integration` (Platform CLI) for a first-class **New Lead** trigger — see root README.
