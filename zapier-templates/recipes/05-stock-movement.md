# Zivvy Stock — Movements & New Items
...
6. **Optional enrich:** Webhooks by Zapier GET `https://api.zivvy.xyz/v1/stock-entries/{{name}}` with Bearer `zk_live_`
...
Import/push `zapier-templates/integration` (Platform CLI) for a first-class **Stock Movement or Item Created** trigger — see root README.
