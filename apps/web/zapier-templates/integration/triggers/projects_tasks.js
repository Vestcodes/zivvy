...
const EVENTS = ["tasks.created","tasks.updated","timesheets.submitted","projects.updated"];
...
const subscribeHook = async (z, bundle) => {
  const response = await z.request({
    ...
    body: {
      ...
      events: EVENTS,
      label: `Zapier: Task, Timesheet, or Project Update`,
...
module.exports = {
  ...
  noun: 'Project Event',
  display: {
    label: 'Task, Timesheet, or Project Update',
    description: 'Triggers on task create/update, timesheet submit, or project update.',
  },
  operation: {
    type: 'hook',
    inputFields: [
