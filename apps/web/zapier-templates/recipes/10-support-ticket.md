...
6. **Optional enrich:** Webhooks by Zapier GET `https://api.zivvy.xyz/v1/support-tickets/{{name}}` with Bearer `zk_live_`
...
Import/push `zapier-templates/integration` (Platform CLI) for a first-class **Support Ticket or Issue Event** trigger — see root README.
