...
export const MODULES: ModuleConfig[] = [
  ...
  },
  {
    key: "helpdesk",
    label: "Helpdesk",
    description: "Customer tickets, knowledge base, and teams",
    viewRoles: ["Agent"],
    fullRoles: ["Agent"],
  },
  {
    ...
    viewRoles: ["Quality Manager"],
    fullRoles: ["Quality Manager"],
  },
  {
    key: "assets",
    label: "Assets",
    description: "Fixed assets, maintenance, and depreciation",
    viewRoles: ["Asset User"],
    fullRoles: ["Asset Manager", "Asset User"],
  },
  {
    key: "insights",
    label: "Insights",
